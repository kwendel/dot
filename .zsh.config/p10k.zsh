# Generated by Powerlevel10k configuration wizard on 2022-10-16 at 15:19 CEST.
...
() {
  ...
  typeset -g POWERLEVEL9K_LEFT_PROMPT_ELEMENTS=(
    ...
    vcs                     # git status
    # Show aws profile even when right prompt is hidden
  ...
  typeset -g POWERLEVEL9K_DIR_MAX_LENGTH=10 # quickly truncate 
  ...
  function my_git_formatter() {
    ...
    if [[ -n $VCS_STATUS_LOCAL_BRANCH ]]; then
      ...
      # default: (( $#branch > 32 )) && branch[13,-13]="…"  # <-- this line
      (( $#branch > 20 )) && branch[20,-1]="…"  # <-- this line
  ...
  # Custom icon.
  typeset -g POWERLEVEL9K_VCS_VISUAL_IDENTIFIER_EXPANSION= # remove git icon
  # Custom prefix.
  ...
  typeset -g POWERLEVEL9K_AWS_SHOW_ON_COMMAND='aws|cdk|awless|terraform|pulumi|terragrunt'
  ...
  typeset -g POWERLEVEL9K_AWS_CLASSES=(
      ...
      # '*test*'  TEST    
      '*dev*'       DEFAULT)
  typeset -g POWERLEVEL9K_AWS_DEFAULT_FOREGROUND=208    # aws orange
  ...
  # Profile is always configure to a region
